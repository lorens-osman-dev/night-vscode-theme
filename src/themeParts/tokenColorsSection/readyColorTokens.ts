import type { TTextMateRule } from "@/types/colors";

// this original Night Shift token colors
export const colorTokens: TTextMateRule[] = [
  {
  ...
  },
  {
    ...
    scope: "storage.type.interface.ts,meta.interface.ts",
    settings: {
      fontStyle: "italic",
      foreground: "#ff00aedd",
    },
  ...
  {
    scope: "storage.type.ts,meta.var.expr.ts,meta.block.ts,meta.arrow.ts,meta.var.expr.ts,source.ts",
    settings: {
      foreground: "#b62b2b",
    },
  },
  {
    ...
    scope: "interface,entity.name.type.interface,entity.name.type",
    settings: {
      foreground: "#b3b450",
      fontStyle: "italic",
    },
  ...
  {
    name: "interface,entity.name.type.interface,entity.name.type",
  ...
  {
    name: "class + extend",
    scope: "storage.type.class.ts,storage.modifier.ts",
    settings: {
      foreground: "#b62b2b",
    },
  },
  ...
  {
    name: "function ",
    scope: "storage.type.function.ts,meta.function.ts,source.ts,storage.type",
    settings: {
      foreground: "#b62b2b",
    },
  },
  {
    name: "variable ",
    scope: "variable.other.readwrite.ts,meta.definition.variable.ts,meta.var-single-variable.expr.ts",
    settings: {
      foreground: "#049fd9",
    },
  },
  {
    name: "Control Elements CCCCCSSSSSSSSSSSSSS",
